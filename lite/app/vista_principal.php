...
//funcion para montar menu
    function montarmenuderecha() {
    	IF (contprinc::comprobarsesion()) {
                ...
                <tr><td><center><b>Bienvenido:</b></br> '.usuario::obtenerdatousuario("nombre", $_SESSION["identificador"]).'</br></br></center></td></tr>
    		    <th>'.constant("usuario".usuario::obtenerdatousuario("tipo", $_SESSION["identificador"])).'</th>';
    		    $tutoria = modelotutor::obtenermitutoria($_SESSION["identificador"]);
    	        if ($tutoria) {
    		         $return .= '<tr><th>Tutoria '.$tutoria.'</th></tr>';
    	        } 
    	        $return .= '</td></tr>
